...
TEST(QvalueTest, basic) {
  ...
  EXPECT_EQ(output[0].first.compare(coral::StringPiece("iso-8859-5")), 0);
  EXPECT_DOUBLE_EQ(output[0].second, 1);
  EXPECT_EQ(output[1].first.compare(coral::StringPiece("unicode-1-1")), 0);
  ...
  EXPECT_EQ(output.size(), 2);
  EXPECT_EQ(output[0].first.compare(coral::StringPiece("compress")), 0);
  EXPECT_DOUBLE_EQ(output[0].second, 1);
  EXPECT_EQ(output[1].first.compare(coral::StringPiece("gzip")), 0);
  ...
  EXPECT_EQ(output[0].first.compare(coral::StringPiece("gzip")), 0);
  EXPECT_DOUBLE_EQ(output[0].second, 1);
  EXPECT_EQ(output[1].first.compare(coral::StringPiece("identity")), 0);
  EXPECT_DOUBLE_EQ(output[1].second, 0.5);
  EXPECT_EQ(output[2].first.compare(coral::StringPiece("*")), 0);
  ...
  EXPECT_EQ(output.size(), 3);
  EXPECT_EQ(output[0].first.compare(coral::StringPiece("da")), 0);
  EXPECT_DOUBLE_EQ(output[0].second, 1);
  EXPECT_EQ(output[1].first.compare(coral::StringPiece("en-gb")), 0);
  EXPECT_DOUBLE_EQ(output[1].second, 0.8);
  EXPECT_EQ(output[2].first.compare(coral::StringPiece("en")), 0);
...
TEST(QvalueTest, invalids) {
  ...
  EXPECT_EQ(output[0].first.compare(coral::StringPiece("gzip")), 0);
  EXPECT_DOUBLE_EQ(output[0].second, 1);
  EXPECT_EQ(output[1].first.compare(coral::StringPiece("defalte")), 0);
  EXPECT_DOUBLE_EQ(output[1].second, 1);
  output.clear();
